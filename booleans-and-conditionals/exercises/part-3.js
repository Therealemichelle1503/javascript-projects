...
if (fuelLevel < 1000 || engineTemperature > 3500 || engineIndicatorLight === "red blinking"){
    ...
    console.log("Check fuel level. Engines runing hot.");
...
e) If fuelLevel is below 1000 OR engineTemperature is above 3500 OR en gineIndicatorLight is red blinking print "ENGINE FAILURE IMMINENT!" 
...
if (fuelLevel >= 21000 && engineTemperature === 1200){
    console.log("command override = false");
} else {
    console.log("command override = true")
}
